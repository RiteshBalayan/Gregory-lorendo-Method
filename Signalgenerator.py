...
class SignalGenerator:
    ...
    def generate_sine_signal(self):
        ...
        time = np.linspace(1, self.data_generator['time_range'], self.data_generator['no_data_points'])#time with asked resolution
        time_p = np.linspace(1, self.data_generator['time_range'], 1000)#high resolution time for ploting only
